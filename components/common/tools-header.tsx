...
function ToolsHeader({ className }: { className?: string }) {
	...
	return (
		<>
			<header className={cn("absolute top-2 z-50 w-full ", className)}>
				<div className=" mx-auto flex max-w-screen-lg items-center justify-between rounded-xl px-3 xl:px-0 2xl:max-w-screen-xl">
					...
					<div className="flex items-center gap-2">
						...
						<ThemeSwitch className="inset-shadow-[0_2px_rgb(0_0_0/0.10)] h-11 w-12 flex-shrink-0 cursor-pointer rounded-md bg-card-bg dark:inset-shadow-[0_1px_rgb(255_255_255/0.15)]" />
						<a
							href="https://x.com/naymur_dev"
							target="_blank"
							rel="noreferrer"
							className="grid h-11 w-12 flex-shrink-0 place-content-center rounded-md border bg-primary text-2xl text-primary-foreground"
						>
