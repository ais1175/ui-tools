	...
	return (
		<>
			...
			<div className="relative min-h-screen text-white ">
				...
				<div className="absolute top-0 right-0 bottom-0 left-0 bg-[linear-gradient(to_right,#4f4f4f29_1px,transparent_1px),linear-gradient(to_bottom,#4f4f4f2e_1px,transparent_1px)] bg-[size:40px_44px] [mask-image:radial-gradient(ellipse_80%_50%_at_50%_0%,#000_70%,transparent_110%)]" />
				<div className="relative mx-auto grid h-full gap-2 px-4 pt-28 pb-2 sm:px-0 md:pt-40 lg:w-[1000px] xl:pb-0">
					...
					<h1 className="relative z-[1] text-center font-semibold text-3xl sm:text-4xl sm:leading-[100%] md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-5xl ">
						...
						<span className="block"> for Design Engineers.</span>
					</h1>
